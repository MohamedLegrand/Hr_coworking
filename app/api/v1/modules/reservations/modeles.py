...
class Reservation(Base):
    ...
    gamme = Column(String(20), nullable=False)
    forfait = Column(String(20), nullable=False)
    prix_total = Column(Numeric(15, 2), nullable=False, default=0)
    cgu_acceptees = Column(Boolean, nullable=False, default=False)
    date_acceptation_cgu = Column(DateTime(timezone=True), nullable=True)
